...
public class MeetingWeekFragment extends Fragment{

    private TextView tvDate = null;
    private ExpandableListView listView = null;
    private FragmentMeetingWeekAdapter mAdapter = null;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_meeting_week, null);
        return view;
    }
    ...
    private void initWidget(View view) {
        ...
        final WeatherMeetingDto data = getArguments().getParcelable("data");
    ...
    private void initListView(View view) {
        ...
        mAdapter = new FragmentMeetingWeekAdapter(getActivity(), groupList, childList, videoList);
    ...
    private void OkHttpMeetingList(String url, final int index) {
