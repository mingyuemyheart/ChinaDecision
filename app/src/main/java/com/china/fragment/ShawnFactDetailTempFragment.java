...
import com.china.view.ShawnTemperatureView;
 ...
 * 实况站点详情-温度
 */
public class ShawnFactDetailTempFragment extends Fragment{
	...
	private ShawnTemperatureView temperatureView = null;
	private TextView tvPrompt = null;

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(R.layout.shawn_fragment_fact_detail_temp, null);
	}
	...
	private void initWidget(View view) {
		...
		TextView tvHighTemp = view.findViewById(R.id.tvHighTemp);
		TextView tvLowTemp = view.findViewById(R.id.tvLowTemp);
		TextView tvAverTemp = view.findViewById(R.id.tvAverTemp);
		...
		if (data != null) {
			...
			temperatureView = new ShawnTemperatureView(getActivity());
