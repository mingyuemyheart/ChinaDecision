...
import com.china.view.ShawnHumidityView;
 ...
 * @author shawn_sun
 */
public class ShawnFactDetailHumidityFragmetn extends Fragment{
	...
	private ShawnHumidityView humidityView = null;
	private TextView tvPrompt = null;

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(R.layout.shawn_fragment_fact_detail_humidity, null);
	}
	...
	private void initWidget(View view) {
		...
		TextView tvHighHumidity = view.findViewById(R.id.tvHighHumidity);
		TextView tvLowHumidity = view.findViewById(R.id.tvLowHumidity);
		...
		if (data != null) {
			...
			humidityView = new ShawnHumidityView(getActivity());
