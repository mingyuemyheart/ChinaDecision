 ...
 * 天气统计
 */
public class WeatherStaticsActivity extends BaseActivity implements OnClickListener, OnMarkerClickListener,
...
//		progressBar.setMarkerProgress(0f);
	...
	public void onMapScreenShot(final Bitmap bitmap1) {//bitmap1为地图截屏
		...
		if (reDetail.getVisibility() == View.VISIBLE) {
			...
			Bitmap bitmap3 = CommonUtil.mergeBitmap(WeatherStaticsActivity.this, bitmap1, bitmap2, true);
		...
		CommonUtil.share(WeatherStaticsActivity.this, bitmap);
	}
	@Override
	...
	public void onClick(View v) {
		...
		case R.id.llBack:
			...
			break;
		case R.id.ivShare:
			aMap.getMapScreenShot(WeatherStaticsActivity.this);
			break;
