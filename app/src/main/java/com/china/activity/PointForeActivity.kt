 ...
 * 格点预报
 */
class PointForeActivity : BaseActivity(), OnClickListener, AMapLocationListener, OnCameraChangeListener, OnMapScreenShotListener, AMap.OnMarkerClickListener {
    ...
    override fun onMapScreenShot(bitmap1: Bitmap?) { //bitmap1为地图截屏
        ...
        bitmap = CommonUtil.mergeBitmap(this, bitmap3, bitmap8, false)
        CommonUtil.clearBitmap(bitmap3)
        CommonUtil.clearBitmap(bitmap8)
        CommonUtil.share(this@PointForeActivity, bitmap)
    }
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.ivShare -> aMap!!.getMapScreenShot(this@PointForeActivity)
            R.id.ivPlay -> {
