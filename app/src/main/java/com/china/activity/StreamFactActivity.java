...
public class StreamFactActivity extends BaseActivity implements OnClickListener, AMapLocationListener, OnCameraChangeListener,
	...
	private ImageView ivLighting,ivRain,ivWind,ivHail,ivRadar,ivData,ivLocation,ivLegendPrompt,ivLegend,ivShare;
	...
	private void initWidget() {
		...
		tvName.setText("全国1小时强对流天气实况"+"("+start+"-"+end+")");
	...
	public void onMapScreenShot(final Bitmap bitmap1) {//bitmap1为地图截屏
		...
		Bitmap bitmap = CommonUtil.mergeBitmap(mContext, bitmap3, bitmap8, false);
		CommonUtil.clearBitmap(bitmap3);
		CommonUtil.clearBitmap(bitmap8);
		CommonUtil.share(StreamFactActivity.this, bitmap);
	}
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.ivRadar:
				...
				break;
			case R.id.ivData:
//				Intent intent = new Intent(mContext, StreamFactListActivity.class);
...
//				intent.putExtras(bundle);
				startActivity(new Intent(mContext, StreamFactListActivity.class));
				break;
			...
			case R.id.ivPlay:
				...
				break;
			case R.id.ivShare:
				aMap.getMapScreenShot(StreamFactActivity.this);
				break;
...
//		}
	...
	public View getInfoContents(final Marker marker) {
		...
		View view = inflater.inflate(R.layout.layout_marker_stream_fact_info, null);
