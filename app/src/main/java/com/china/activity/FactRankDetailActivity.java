 ...
 * 实况监测详情
 */
public class FactRankDetailActivity extends BaseActivity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.ivShare:
			...
			Bitmap bitmap3 = CommonUtil.mergeBitmap(FactRankDetailActivity.this, bitmap1, bitmap2, false);
			CommonUtil.clearBitmap(bitmap1);
			CommonUtil.clearBitmap(bitmap2);
			Bitmap bitmap4 = BitmapFactory.decodeResource(getResources(), R.drawable.shawn_legend_share_landscape);
			Bitmap bitmap = CommonUtil.mergeBitmap(FactRankDetailActivity.this, bitmap3, bitmap4, false);
			CommonUtil.clearBitmap(bitmap3);
			CommonUtil.clearBitmap(bitmap4);
			CommonUtil.share(FactRankDetailActivity.this, bitmap);
			break;
