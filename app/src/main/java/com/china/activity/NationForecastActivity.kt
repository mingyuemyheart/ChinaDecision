 ...
 * 国外城市天气预报
 */
class NationForecastActivity : BaseActivity(), OnClickListener, OnMarkerClickListener, OnMapClickListener, InfoWindowAdapter, OnInfoWindowClickListener, OnMapScreenShotListener {
                        ...
                        if (!TextUtils.isEmpty(result)) {
                            try {
                                ...
                                for (i in 0 until array.length()) {
                                    ...
                                    if (!obj.isNull("name")) {
                                        dto.cityName = obj.getString("name")
                                    }
                                    if (!obj.isNull("code")) {
                                        dto.cityId = obj.getString("code")
                                    }
                                    if (!obj.isNull("lat")) {
