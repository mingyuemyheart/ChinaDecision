...
public class WarningStatisticListActivity extends BaseActivity implements View.OnClickListener {
    ...
    private WarningStatisticListGroupAdapter mAdapter = null;
    ...
    private WarningStatisticListSelectAdapter adapter1 = null;
    private List<WarningDto> list1 = new ArrayList<>();
    private GridView gridView2 = null;
    private WarningStatisticListSelectAdapter adapter2 = null;
    ...
    private void initListView() {
        ...
        mAdapter = new WarningStatisticListGroupAdapter(mContext, groupList, childList);
    ...
    private void initGridView1() {
        ...
        if (gridView1 != null && adapter1 != null) {
            ...
            adapter1 = new WarningStatisticListSelectAdapter(mContext, list1);
    ...
    private void initGridView2() {
        ...
        if (gridView2 != null && adapter2 != null) {
            ...
            adapter2 = new WarningStatisticListSelectAdapter(mContext, list2);
