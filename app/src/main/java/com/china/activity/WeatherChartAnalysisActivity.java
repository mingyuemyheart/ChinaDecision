    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv1:
                ...
                tv2.setTextColor(getResources().getColor(R.color.text_color2));
                tv3.setTextColor(getResources().getColor(R.color.text_color2));
            ...
            case R.id.tv2:
                type = 2;
                tv1.setTextColor(getResources().getColor(R.color.text_color2));
