 ...
 * @author shawn_sun
 */
public class ShawnDisasterReportActivity extends ShawnBaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.shawn_activity_disaster_report);
		mContext = this;
		initRefreshLayout();
		initWidget();
		initListView();
	...
	private void initListView() {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				Intent intent = new Intent(mContext, ShawnDisasterReportDetailActivity.class);
