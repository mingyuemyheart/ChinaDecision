...
import com.china.R;
import com.china.adapter.ShawnDisasterSpecialAdapter;
 ...
 * 灾情专报
 */
public class ShawnDisasterSpecialActivity extends ShawnBaseActivity implements OnClickListener{
	
	private Context mContext = null;
	private TextView tvTitle = null;
	private ShawnDisasterSpecialAdapter mAdapter = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.shawn_activity_disaster_special);
		mContext = this;
		initRefreshLayout();
		initWidget();
		initListView();
	...
	private void initListView() {
		...
		mAdapter = new ShawnDisasterSpecialAdapter(mContext, dataList);
