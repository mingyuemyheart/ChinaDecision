...
import com.china.R;
import com.china.adapter.ShawnDecisionNewsAdapter;
 ...
 * @author shawn_sun
 */
public class ShawnDecisionNewsActivity extends ShawnBaseActivity implements OnClickListener{
	
	private Context mContext = null;
	private TextView tvTitle = null;
	private ShawnDecisionNewsAdapter mAdapter = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.shawn_activity_decision_news);
		mContext = this;
		initRefreshLayout();
		initWidget();
		initListView();
	...
	private void initListView() {
		...
		mAdapter = new ShawnDecisionNewsAdapter(mContext, dataList);
