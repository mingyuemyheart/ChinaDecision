...
public class ShawnWaitWindActivity extends ShawnBaseActivity implements OnClickListener, AMap.OnMapScreenShotListener, OnCameraChangeListener,
    ...
    public void onMapScreenShot(final Bitmap bitmap1) {//bitmap1为地图截屏
        ...
        Bitmap bitmap3 = CommonUtil.mergeBitmap(ShawnWaitWindActivity.this, bitmap1, bitmap2, true);
        ...
        CommonUtil.share(ShawnWaitWindActivity.this, bitmap);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.llBack:
                ...
                break;
            case R.id.ivShare:
                aMap.getMapScreenShot(ShawnWaitWindActivity.this);
                break;
            case R.id.ivSwitch:
                if (isGfs) {
    ...
    private void checkAuthority() {
        if (Build.VERSION.SDK_INT < 23) {
            ...
            if (deniedList.isEmpty()) {//所有权限都授予
                ...
                ActivityCompat.requestPermissions(ShawnWaitWindActivity.this, permissions, AuthorityUtil.AUTHOR_LOCATION);
            }
        }
    }
            ...
            case AuthorityUtil.AUTHOR_LOCATION:
                if (grantResults.length > 0) {
                    ...
                    for (String permission : permissions) {
                        if (!ActivityCompat.shouldShowRequestPermissionRationale(ShawnWaitWindActivity.this, permission)) {
                            AuthorityUtil.intentAuthorSetting(mContext, "\""+getString(R.string.app_name)+"\""+"需要使用您的位置权限、存储权限，是否前往设置？");
                            break;
                        }
                    }
