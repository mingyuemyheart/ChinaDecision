 ...
 * 产品订阅
 */
public class ShawnProductOrderSubmitActivity2 extends ShawnBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shawn_activity_product_order2_submit);
        context = this;
        initWidget();
        initWheelView();
    }
