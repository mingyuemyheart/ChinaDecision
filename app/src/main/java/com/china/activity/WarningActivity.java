 ...
 * 预警
 */
public class WarningActivity extends ShawnBaseActivity implements OnClickListener, AMapLocationListener, OnMapClickListener,
					...
					public void run() {
						if (!TextUtils.isEmpty(result)) {
							try {
								...
								tvName1.setText("全国大雾区域预报" + layerTime24);
								tvName2.setText("全国强降雨落区预报" + layerTime24);
//									tvName3.setText("全国强降雨落区预报" + enter + layerTime24);
//									tvName4.setText("全国强降雨落区预报" + enter + layerTime24);
								tvName5.setText("全国高温区域预报" + layerTime12);
