 ...
 * @author shawn_sun
 */
public class ShawnStreamFactListActivity extends ShawnBaseActivity implements OnClickListener {
	...
	private void initWidget() {
		...
		tvListName.setText(String.format("全国1小时%s实况(%s-%s)", tvRain1.getText().toString(), start, end));
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.reWind:
				...
				tvListName.setText(String.format("全国1小时%s实况(%s-%s)", tvWind1.getText().toString(), start, end));
				tvStationName.setText("站名");
				tvProvince.setText("行政区划");
				tvStationId.setText("站号");
			...
			case R.id.reLighting:
				...
				tvListName.setText(String.format("全国1小时%s实况(%s-%s)", tvLighting1.getText().toString(), start, end));
			...
			case R.id.reHail:
				...
				tvListName.setText(String.format("全国1小时%s实况(%s-%s)", tvHail1.getText().toString(), start, end));
				tvStationName.setText("站名");
				tvProvince.setText("行政区划");
				tvStationId.setText("站号");
				tvUnit.setText("("+getString(R.string.unit_mm)+")");
