 ...
 * 产品订阅
 */
public class ShawnProductOrderActivity extends ShawnBaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.llBack:
                ...
                break;
            case R.id.llMail:
                startActivityForResult(new Intent(this, ShawnModifyMailActivity.class), 1001);
                break;
