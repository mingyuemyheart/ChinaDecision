 ...
 * 视频会商
 */
public class WeatherMeetingAdapter extends BaseExpandableListAdapter {
	...
	public WeatherMeetingAdapter(Context context, List<WeatherMeetingDto> groupList, List<List<WeatherMeetingDto>> childList, List<WeatherMeetingDto> videoList){
	...
	public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			convertView = mInflater.inflate(R.layout.adapter_weather_meeting_header, null);
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			convertView = mInflater.inflate(R.layout.adapter_weather_meeting_content, null);
