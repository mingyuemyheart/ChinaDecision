 ...
 * 预警列表-筛选
 */
public class ShawnWarningListScreenAdapter extends BaseAdapter{
	...
	public ShawnWarningListScreenAdapter(Context context, List<WarningDto> mArrayList, int flag) {
		mContext = context;
		this.flag = flag;
