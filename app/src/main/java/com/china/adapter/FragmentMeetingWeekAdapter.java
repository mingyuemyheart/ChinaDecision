...
public class FragmentMeetingWeekAdapter extends BaseExpandableListAdapter {
	...
	private SimpleDateFormat sdf4 = new SimpleDateFormat("MM月dd日");
	private SimpleDateFormat sdf5 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");

	public FragmentMeetingWeekAdapter(Context context, List<WeatherMeetingDto> groupList, List<List<WeatherMeetingDto>> childList,
	List<WeatherMeetingDto> videoList){
		mContext = context;
	...
	public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		if(convertView == null){
			convertView = mInflater.inflate(R.layout.adapter_fragment_meeting_week_header, null);
			groupHolder = new GroupHolder();
			groupHolder.tvHeader = (TextView) convertView.findViewById(R.id.tvHeader);
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
		if(convertView == null){
			convertView = mInflater.inflate(R.layout.adapter_fragment_meeting_week_content, null);
			childHolder = new ChildHolder();
			childHolder.tvTime = (TextView) convertView.findViewById(R.id.tvTime);
			childHolder.tvTitle = (TextView) convertView.findViewById(R.id.tvTitle);
			childHolder.tvLive = (TextView) convertView.findViewById(R.id.tvLive);
