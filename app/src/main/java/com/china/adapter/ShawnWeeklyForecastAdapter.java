 ...
 * 15天预报
 */
public class ShawnWeeklyForecastAdapter extends BaseAdapter{
	...
	private final class ViewHolder{
		...
		ImageView ivHighPhe,ivLowPhe,ivHighWind,ivLowWind;
	}
	
	public ShawnWeeklyForecastAdapter(Context context, List<WeatherDto> mArrayList) {
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder mHolder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.shawn_adapter_weekly_forecast, null);
