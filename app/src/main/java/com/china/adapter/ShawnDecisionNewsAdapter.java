 ...
 * @author shawn_sun
 */
public class ShawnDecisionNewsAdapter extends BaseAdapter{
	...
	public ShawnDecisionNewsAdapter(Context context, List<DisasterDto> mArrayList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder mHolder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.shawn_adapter_decision_news, null);
