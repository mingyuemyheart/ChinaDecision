 ...
 * 五天降水统计
 */
public class FiveRainAdapter extends BaseAdapter {
    ...
    public FiveRainAdapter(Context context, List<StationMonitorDto> mArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder mHolder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.adapter_five_rain, null);
