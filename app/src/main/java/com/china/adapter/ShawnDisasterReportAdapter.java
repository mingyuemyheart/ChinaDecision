 ...
 * 灾情直报
 */
public class ShawnDisasterReportAdapter extends BaseAdapter{
	...
	public ShawnDisasterReportAdapter(Context context, List<DisasterReportDto> mArrayList) {
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder mHolder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.shawn_adapter_disaster_report, null);
