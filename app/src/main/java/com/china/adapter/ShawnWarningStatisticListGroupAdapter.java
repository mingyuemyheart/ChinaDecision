...
public class ShawnWarningStatisticListGroupAdapter extends BaseExpandableListAdapter {
    ...
    public ShawnWarningStatisticListGroupAdapter(Context context, List<WarningDto> groupList, List<List<WarningDto>> childList){
        mContext = context;
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = mInflater.inflate(R.layout.shawn_adapter_warning_statistic_list_group, null);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = mInflater.inflate(R.layout.shawn_adapter_warning_statistic_list_child, null);
