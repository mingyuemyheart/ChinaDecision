 ...
 * 模块管理
 */
public class ShawnManageAdapter extends BaseAdapter implements StickyGridHeadersSimpleAdapter {

	private Context mContext;
	private LayoutInflater mInflater;
	private List<ColumnData> mArrayList;

	public ShawnManageAdapter(Context context, List<ColumnData> mArrayList) {
		mContext = context;
	...
	public View getHeaderView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.shawn_adapter_manage_header, null);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.shawn_adapter_manage_content, null);
			mHolder.ivSelected = convertView.findViewById(R.id.ivSelected);
