...
//			paint.setTypeface(Typeface.create("System", Typeface.BOLD));
			float tempWidth = paint.measureText("将二维码放入框内, 即可自动扫描");
			canvas.drawText("将二维码放入框内, 即可自动扫描", (width-tempWidth)/2, (float) (frame.bottom + (float)TEXT_PADDING_TOP *density), paint);
